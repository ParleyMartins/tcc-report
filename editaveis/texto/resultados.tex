...
A central part of the template is the ability to build, run and package the game. This ability happens because several scripts allow users to quickly do this process, by running them from the root directory of the repository. None of these scripts should be modified by the user.
...
These two games also presented a few challenges, but they were resolved. \textit{Wenova} got
