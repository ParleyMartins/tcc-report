...
\lstinputlisting[language=bash, frame=single, caption={Part of \texttt{gen\_wxs.sh}}, label=lst:gen_wxs.sh, firstnumber=189, firstline=189]{../proj-template/scripts/util/gen_wxs.sh}
