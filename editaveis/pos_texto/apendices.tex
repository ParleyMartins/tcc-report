...
\footnotetext{Available on the repository README.md}
...
\begin{figure}[h!]
\centering
\fbox{\includegraphics[width=0.6\textwidth,keepaspectratio]{prints/space_bug1}}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.6\textwidth,keepaspectratio]{prints/ankh_cut}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.6\textwidth,keepaspectratio]{prints/travel_fase3}
